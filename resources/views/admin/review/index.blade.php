    ...
    <table class="table table-bordered table-striped table-hover align-middle shadow-sm small">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-center">
                    <i class="bi bi-clock me-1 text-secondary"></i>{{ $review->created_at->format('H:i:s d.m.Y') }}
                </td>
                <td class="text-center">
                    <i class="bi bi-clock me-1 text-secondary"></i>{{ $review->updated_at->format('H:i:s d.m.Y') }}
                </td>
            </tr>
            @empty
            <tr>
