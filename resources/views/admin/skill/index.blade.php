...
<div class="row align-items-center mb-3">
    <div class="col-auto ps-3 fw-bold">Skills</div>
    ...
    <table class="table table-bordered table-striped table-hover align-middle shadow-sm small">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $obj->name }}</td>
                <td>
                    <a href="{{ route('admin.skill.edit', $obj->id) }}" class="btn btn-sm btn-warning btn-outline-dark">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0 shadow-lg rounded-4">
                                <div class="modal-header bg-danger text-white border-0 rounded-top p-3">
                                    <div class="fw-bold" id="deleteModalLabel-{{ $obj->id }}">Confirm Deletion</div>
                                ...
                                <div class="modal-footer justify-content-center border-0 mb-3">
                                    <form method="POST" action="{{ route('admin.skill.destroy', $obj->id) }}" class="d-flex gap-2">
                                        @csrf
                                        @method('DELETE')
