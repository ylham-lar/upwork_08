...
<div class="row align-items-center mb-3">
    <div class="col-auto h2 ps-3">Users</div>
    ...
    <table class="table table-bordered table-striped table-hover align-middle shadow-sm small">
        <thead class="table-light text-center align-middle">
            <tr>
                ...
                <th><i class="bi bi-clock-history text-primary me-1"></i>Created At</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <a href="{{ route('admin.user.edit', $obj->id) }}" class="btn btn-sm btn-outline-dark btn-warning">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                            <div class="modal-content border-0 shadow-lg rounded-4">
                                <div class="modal-header bg-danger text-white border-0 rounded-top p-3">
                                    <h5 class="modal-title fw-bold" id="deleteModalLabel-{{ $obj->id }}">Confirm Deletion</h5>
                                ...
                                <div class="modal-body p-4 text-center">
                                    ...
                                    <div class="fs-6">
                                        Are you sure you want to delete the user <strong>{{ $obj->name }}</strong>?
                                    </div>
                                </div>

                                <div class="modal-footer justify-content-center border-0 mb-3">
                                    <form method="POST" action="{{ route('admin.user.destroy', $obj->id) }}" class="d-flex gap-2">
                                        @csrf
                                        @method('DELETE')
