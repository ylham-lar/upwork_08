...
<div class="container-sm py-4">
    <div class="row justify-content-center">
        <div class="col-md-10 col-lg-8">
            ...
            <form action="{{ route('admin.client.update', $obj->id) }}" method="POST" enctype="multipart/form-data" class="bg-white p-4 rounded-4 shadow-sm">
                @csrf
                @method('PUT')
                ...
                <div class="row g-3 mb-3">
                    ...
                    <div class="col">
                        ...
                        <input type="password" class="form-control @error('password') is-invalid @enderror" id="password" name="password" placeholder="Enter new password if you want to change">
                        @error('password')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col">
                        ...
                        <select class="form-select @error('phone_number_verified') is-invalid @enderror" id="phone_number_verified" name="phone_number_verified">
                            <option value="0" {{ old('phone_number_verified', $obj->phone_number_verified) == 0 ? 'selected' : '' }}>No</option>
                            <option value="1" {{ old('phone_number_verified', $obj->phone_number_verified) == 1 ? 'selected' : '' }}>Yes</option>
                        </select>
                    ...
                    <div class="col">
                        ...
                        <select class="form-select @error('payment_method_verified') is-invalid @enderror" id="payment_method_verified" name="payment_method_verified">
                            <option value="0" {{ old('payment_method_verified', $obj->payment_method_verified) == 0 ? 'selected' : '' }}>No</option>
                            <option value="1" {{ old('payment_method_verified', $obj->payment_method_verified) == 1 ? 'selected' : '' }}>Yes</option>
                        </select>
                    ...
                    <div class="col">
                        ...
                        <input type="number" min="0" class="form-control @error('total_spent') is-invalid @enderror" id="total_spent" name="total_spent" value="{{ old('total_spent', $obj->total_spent) }}">
                        @error('total_spent')
                        <div class="invalid-feedback d-block">{{ $message }}</div>
                        @enderror
                    </div>
