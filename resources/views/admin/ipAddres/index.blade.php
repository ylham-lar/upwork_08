        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="text-nowrap text-secondary">
                    <i class="bi bi-clock me-1"></i>{{ $ip_Address->created_at ? $ip_Address->created_at->format('H:i d.m.Y') : '—' }}
                </td>
                <td class="text-nowrap text-secondary">
                    <i class="bi bi-clock-history me-1"></i>{{ $ip_Address->updated_at ? $ip_Address->updated_at->format('H:i d.m.Y') : '—' }}
                </td>
            </tr>
            @empty
            <tr>
