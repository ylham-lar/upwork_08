...
<div class="container-sm py-4">
    <div class="row justify-content-center">
        <div class="col-md-6 col-lg-5">
            ...
            <div class="h4 mb-4">
                <a href="{{ route('admin.location.index') }}" class="text-decoration-none text-success">
            ...
            <form action="{{ route('admin.location.update', $obj->id) }}" method="POST" class="bg-white p-4 rounded-4 shadow-sm">
                @csrf
                @method('PUT')
                ...
                <div class="text-center d-flex justify-content-center gap-3">
                    <a href="{{ route('admin.location.index') }}" class="btn btn-outline-secondary px-4 py-2">
